...
public interface IRedisClient{
     ...
     * @param value 值 
     * @param expire seconds, -1表示无时间限制
     * @return Bulk reply
     */
    
    public String set(final String key,final String nameSpace, final String value,final int expire);
     ...
     * @param expire expire time in the units of {@param #expx}
     * @return Status code reply
     */
    
    public String set(final String bizkey,final String nameSpace, final String value, final String nxxx, final String expx, final long expire);
...
/*    public <T> T get(String key, TypeReference<T> type, final GetDataCallBack<T> gbs) ;*/
     ...
     * @return <T> 泛型对象
     */
    public <T> T hgetObject(final String bizkey,final String nameSpace,final String field, Class<T> value,final GetDataCallBack<T> gbs);
     ...
     * @return <T> 泛型对象
     */
    public <T> T hgetObject(final String bizkey,final String nameSpace,final String field, TypeReference<T> type,final GetDataCallBack<T> gbs);    
     ...
     * @param <T> 泛型对象
     */
    public <T> Map<String, T> hgetAllObjects(final String bizkey,final String nameSpace,Class<T> value,final GetDataCallBack<T> gbs);
     ...
     * @param  TypeReference<T> type
     */
    public <T> Map<String, T> hgetAllObjects(final String bizkey,final String nameSpace, TypeReference<T> type,final GetDataCallBack<T> gbs);

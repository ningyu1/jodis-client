...
import io.github.ningyu.redis.client.GetDataCallBack;
import io.github.ningyu.redis.client.IRedisClient;
import io.github.ningyu.redis.utils.CacheUtils;
...
public class RedisClientImpl extends DefaultClientImpl implements IRedisClient{
	...
	public RedisClientImpl(JedisResourcePool jedisPool){
		super(jedisPool);
	}	
    ...
    protected <R> R performFunction(String entrykey,CallBack<R> callBack) {
    	 return execute(getJedisPool(),callBack,false);
    }  
     ...
     * @return 结果集合
     */
    protected <R> R performFunction(String entrykey,CallBack<R> callBack,boolean proxyFlag) {
    	 return execute(getJedisPool(),callBack,proxyFlag);
    }      
     ...
     */
    @Override
    public String set(final String bizkey,final String nameSpace, final String value, final String nxxx, final String expx, final long time) {
    	final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
     ...
     * {@inheritDoc}
     ...
     @Override
     public Long rpush(final String bizkey,final String nameSpace, final String value) {
     return this.performFunction(key, new CallBack<Long>() {
     public Long invoke(Jedis jedis) {
     ...
     * @return 存入值
     @Override
     public Long lpush(final String bizkey,final String nameSpace, final String value) {
     return this.performFunction(key, new CallBack<Long>() {
     public Long invoke(Jedis jedis) {
     ...
     */
    @Override
    public Set<String> zrangeByScore(final String bizkey,final String nameSpace, final double min, final double max, final int offset,
            final int count) {
    	final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
    	return this.performFunction(key, new CallBack<Set<String>>() {
            public Set<String> invoke(Jedis jedis) {
     ...
     */
    @Override
    public Set<String> zrevrangeByScore(final String bizkey,final String nameSpace, final double max, final double min, final int offset,
            final int count) {
    	final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
    	return this.performFunction(key, new CallBack<Set<String>>() {
            public Set<String> invoke(Jedis jedis) {
     ...
     */
    @Override
    public Set<Tuple> zrangeByScoreWithScores(final String bizkey,final String nameSpace, final double min, final double max) {
    	final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
    	return this.performFunction(key, new CallBack<Set<Tuple>>() {
            public Set<Tuple> invoke(Jedis jedis) {
     ...
     */
    @Override
    public Set<Tuple> zrangeByScoreWithScores(final String bizkey,final String nameSpace, final double min, final double max, final int offset,
            final int count) {
    	final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
    	return this.performFunction(key, new CallBack<Set<Tuple>>() {
            public Set<Tuple> invoke(Jedis jedis) {
     ...
     */
    @Override
    public Long linsert(final String bizkey,final String nameSpace, final LIST_POSITION where, final String pivot, final String value) {
    	final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
    	return this.performFunction(key, new CallBack<Long>() {
            public Long invoke(Jedis jedis) {
     ...
     */
/*    @Override
    public <T> T get(String key, TypeReference<T> type,final GetDataCallBack<T> gbs) {
    	String res = get(key,null);
    	T rtn = null;
    	if(StringUtils.isNotEmpty(res)){
    		rtn = JSON.parseObject(res, type);
    	}else{
    		if(gbs!=null){
    			rtn = gbs.invoke();
    		}
	...
	@Override
	public <T> Long hsetObject(String bizkey, String nameSpace, String field,
			T value) {
    	final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
	...
	public <T> T hgetObject(final String bizkey,final String nameSpace,final String field,
			Class<T> value,final GetDataCallBack<T> gbs) {
    	final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
	...
	@Override
	public <T> Map<String, T> hgetAllObjects(final String bizkey,final String nameSpace,
			final TypeReference<T> type,final GetDataCallBack<T> gbs) {
		final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
	...
	@Override
	public <T> Map<String, T> hgetAllObjects(final String bizkey,final String nameSpace,
			final Class<T> value,final GetDataCallBack<T> gbs) {
		final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
        return this.performFunction(key, new CallBack<Map<String, T>>() {
            public Map<String, T> invoke(Jedis jedis) {
            	try{
	...
	@Override
	public <T> List<T> hvalsObject(final String bizkey,final String nameSpace,
	...
	@Override
	public <T> List<T> hvalsObject(String bizkey, String nameSpace,
			Class<T> type) {
		final String key = CacheUtils.getKeyByNamespace(bizkey,nameSpace);
    	List<String> res= hvals(bizkey,nameSpace);
    	List<T> rtnList = null;
	...
	public Object patternDel(final String pattern, final String nameSpace) {
		...
		//final String script = "return redis.call('del', unpack(redis.call('keys','"+patternKey+"')))"; 
